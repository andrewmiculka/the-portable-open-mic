...
import * as RIFFWAVE from './riffwave.js'

export default class Animalese {
  letters_file: string = './animalese.wav';
  onload: Function | undefined;

  constructor(onload: Function | undefined) {
    this.onload = onload;
  }


  const textToAnimalese = function(script: string, shorten: boolean, pitch: number) {
  ...
  xhr.open('GET', this.letters_file);
